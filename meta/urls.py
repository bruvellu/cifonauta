...
from . import views
from .views import CuradoriaMediaList, MediaDetail, MyMedias, RevisionMedia, ManageSpecialists
...
urlpatterns = [
        ...
        path('administrative-module/manage-specialists', ManageSpecialists.as_view(), name='manage_specialists'),
